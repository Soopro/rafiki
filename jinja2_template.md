...
Learn more from here http://jinja.pocoo.org/docs/dev/templates
...
* `meta`: dict of page data.
  ...
  * `date_formatted`: **[ str ]** formatted date.
  * `content`: **[ str ]** content.
  * `description`: **[ str ]** description. (worte by editor)
  * `excerpt`: **[ str ]** content excerpt. (generated by system, if has no description)
  * ... *Custom fields*
